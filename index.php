        ...
        <section id="discountSection" class="viewSection" data-aos="zoom-in" data-aos-duration="1500">
            <div class="titleWraper">
                <h1>Discounts
                    <svg class="material-icons" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" focusable="false" width="1em" height="1em" style="-ms-transform: rotate(360deg); -webkit-transform: rotate(360deg); transform: rotate(360deg);" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
                        <defs>
                            <path id="IconifyId-17a1b105d24-fa01a5-99" d="M-22 2.24h42V22h-42z" />
                        </defs>
                        <clipPath id="IconifyId-17a1b105d24-fa01a5-100">
                            <use xlink:href="#IconifyId-17a1b105d24-fa01a5-99" overflow="visible" />
                        </clipPath>
                        <path clip-path="url(#IconifyId-17a1b105d24-fa01a5-100)" d="M16.543 8.028c-.023 1.503-.523 3.538-2.867 4.327c.734-1.746.846-3.417.326-4.979c-.695-2.097-3.014-3.735-4.557-4.627c-.527-.306-1.203.074-1.193.683c.02 1.112-.318 2.737-1.959 4.378C4.107 9.994 3 12.251 3 14.517C3 17.362 5 21 9 21c-4.041-4.041-1-7.483-1-7.483C8.846 19.431 12.988 21 15 21c1.711 0 5-1.25 5-6.448c0-3.133-1.332-5.511-2.385-6.899c-.347-.458-1.064-.198-1.072.375" />
                    </svg>
